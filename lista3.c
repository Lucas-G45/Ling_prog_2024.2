...
void questao01() {
 int num;
 printf("Os números de 1 a 100 são:\n");
...
void questao02() {
int num;
printf("Os números pares de 100 a 1 são:\n");
...
void questao03() {
int num;
printf("Os múltiplos de 5, no intervalo de 1 a 500 são:\n");
...
int idade, num;
    for(num=1; num<=20; num++){
        printf("Digite respectivamente seu nome, seu sexo e sua idade. PS: Use 'm' ou 'f' para o sexo\n");
        scanf(" %60[^\n] %c %d", nome, &sexo, &idade);
        if(sexo=='m' && idade>21) {
            printf("%s\n",nome);
        }
    }
    printf("Esses são os nomes dos homens com mais de 21 anos");
}
